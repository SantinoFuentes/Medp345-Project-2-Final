...
async function loadMovies(searchTerm){
    const URL = `https://omdbapi.com/?s=${searchTerm}&page=1&apikey=f2aef246`;
...
function loadMovieDetails(){
    ...
    searchListMovies.forEach(movie => {
        movie.addEventListener('click', async () => {
            ...
            const result = await fetch(`http://www.omdbapi.com/?i=${movie.dataset.id}&apikey=f2aef246`);
...
function displayMovieDetails(details){
    ...
    <div class = "movie-info">
        ...
        <p class = "imdbRating"><b> imdbRating:</b> ${details.imdbRating}</p> 
